...
import { type UpdateParkingLotInfoRequest } from '@app/dto/inputs/parking-lot/update-parking-lot-info-input.ts';
...
@injectable()
export class UpdateParkingLotInfoUseCase implements UseCase<
